...
`,t0=t=>{let{cascade:e=!1,damping:r=.5,delay:a=0,duration:n=1e3,fraction:o=0,keyframes:s=tL,triggerOnce:c=!1,css:f,className:l,style:m,childClassName:d,childStyle:p,children:u,onVisibilityChange:y}=t,h=(0,i.useMemo)(()=>(function({duration:t=1e3,delay:e=0,timingFunction:r="ease",keyframes:a=tL,iterationCount:n=1}){return tw`
  ...
  `})({keyframes:s,duration:n}),[n,s]);return void 0==u?null:"string"==typeof u||"number"==typeof u||"boolean"==typeof u?tI(t1,{...t,animationStyles:h,children:String(u)}):(0,tj.isFragment)(u)?tI(t3,{...t,animationStyles:h}):tI(tT,{children:i.Children.map(u,(s,u)=>{if(!(0,i.isValidElement)(s))return null;let g=[f,h],b=a+(e?u*n*r:0);switch(s.type){case"ol":case"ul":return tI(tC,{children:({cx:e})=>tI(s.type,{...s.props,className:e(l,s.props.className),style:{...m,...s.props.style},children:tI(t0,{...t,children:s.props.children})})});case"li":return tI(tM,{threshold:o,triggerOnce:c,onChange:y,children:({inView:t,ref:e})=>tI(tC,{children:({cx:r})=>tI(s.type,{...s.props,ref:e,className:r(d,s.props.className),css:t?g:tK,style:{...p,...s.props.style,animationDelay:b+"ms"}})})});default:return tI(tM,{threshold:o,triggerOnce:c,onChange:y,children:({inView:t,ref:e})=>tI("div",{ref:e,className:l,css:t?g:tK,style:{...m,animationDelay:b+"ms"},children:tI(tC,{children:({cx:t})=>tI(s.type,{...s.props,className:t(d,s.props.className),style:{...p,...s.props.style}})})})})}})})},t1=t=>{let{animationStyles:e,cascade:r=!1,damping:a=.5,delay:n=0,duration:o=1e3,fraction:s=0,triggerOnce:i=!1,css:c,className:f,style:l,children:m,onVisibilityChange:d}=t,{ref:p,inView:u}=tP({triggerOnce:i,threshold:s,onChange:d});return r?tI("div",{ref:p,className:f,css:[c,tQ],style:l,children:m.split("").map((t,r)=>tI("span",{css:u?e:tK,style:{animationDelay:n+r*o*a+"ms"},children:t},r))}):tI(t3,{...t,children:m})},t3=t=>{let{animationStyles:e,fraction:r=0,triggerOnce:a=!1,css:n,className:o,style:s,children:i,onVisibilityChange:c}=t,{ref:f,inView:l}=tP({triggerOnce:a,threshold:r,onChange:c});return tI("div",{ref:f,className:o,css:l?[n,e]:tK,style:s,children:i})};tk`
  from,
  20%,
  40%,
  60%,
...
`,eA=t=>{let{direction:e,reverse:r=!1,...a}=t,n=(0,i.useMemo)(()=>(function(t,e){switch(e){case"down":return t?eS:ev;case"left":return t?eC:ex;case"right":return t?eO:ew;case"up":return t?e_:ek;default:return t?e$:eb}})(r,e),[e,r]);return tI(t0,{keyframes:n,...a})}}}]);